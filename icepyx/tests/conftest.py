...
def mock_settings_env_vars():
    with mock.patch.dict(
        "os.environ",
        {
            "EARTHDATA_USERNAME": "icepyx_mocked",
...
def mock_harmony_api(monkeypatch):
    ...
    monkeypatch.setattr(
        "icepyx.core.query.HarmonyApi.__init__",
        mock_harmony_init
    )
...
# This pollutes the environment with the test user's credentials
